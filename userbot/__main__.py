    ...
    with open(name) as f:
        ...
        try:
         ...
         load_module(shortname.replace(".py", ""))
            ...
            pass
print("Flaming has been deployed! ")

print("Setting up Flaming")
...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
        ...
        with open(name) as f:
            ...
            try:
             ...
             load_assistant(shortname.replace(".py", ""))
                ...
                pass
    sed.info("Flaming Has Been Deployed Successfully !")
    sed.info("╔════❰ Ⲃⲟⲧ Ⲓⲛϝⲟʀⲙⲁⲧⲓⲟⲛ ❱═❍⊱❁۪۪")
    sed.info("║┣⪼ Ⲟⲱⲛⲉʀ - FLAMING USER ")
    ...
    sed.info("║┣⪼ ✨FLAMING USERBOT✨")
    sed.info("║╰━━━━━━━━━━━━━━━➣ ")
    sed.info("╚══════════════════❍⊱❁۪۪")
else:
    sed.info("Flaming Has Been Installed Sucessfully !")
    sed.info("You Can Visit @flaming For Any Support Or Doubts")

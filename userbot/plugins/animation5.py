...
@borg.on(flaming_cmd(outgoing=True, pattern="bufferedd( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(outgoing=True, pattern="dabba( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(flaming_cmd(outgoing=True, pattern="kein( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(flaming_cmd(outgoing=True, pattern="dhab( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(flaming_cmd(outgoing=True, pattern="hart( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(outgoing=True, pattern="raped( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(outgoing=True, pattern="fnl( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(outgoing=True, pattern="monkey( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@borg.on(flaming_cmd(outgoing=True, pattern="herber( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@borg.on(flaming_cmd(outgoing=True, pattern="hand( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(flaming_cmd(outgoing=True, pattern="gsg( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(flaming_cmd(outgoing=True, pattern="theart( (.*)|$)"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(flaming_cmd(pattern=r"fdance"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1

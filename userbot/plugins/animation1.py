...
@borg.on(flaming_cmd(pattern="stupid$"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern=f"bombs$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern=r"call$"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern="wtf$"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern="ding$"))
async def _(event):
...
@borg.on(flaming_cmd(pattern=f"hypno$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(flaming_cmd(pattern="gangasta$"))
async def _(event):
...
@borg.on(flaming_cmd(pattern=f"charging$"))

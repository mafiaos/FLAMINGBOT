...
from userbot.utils import flaming_cmd, edit_or_reply, sudo_cmd
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        ...
        return
    req = requests.get("https://te.legra.ph/file/c1672f2d5ac436575fc3b.mp4")
    ...
    with BytesIO() as sticker:
        ...
        await borg.send_message(
           ...
           "𝙿𝚈𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽          : 3.9.0\n"
            ...
            "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ FLAMING ](https://t.me/flamingsupport)\n"
            "[ ┏┓━┏┓━━━━┏┓━┏┓━━━━━\n ┃┃━┃┃━━━━┃┃━┃┃━━━━━\n ┃┗━┛┃┏━━┓┃┃━┃┃━┏━━┓\n ┃┏━┓┃┃┏┓┃┃┃━┃┃━┃┏┓┃ \n ┃┃━┃┃┃┃━┫┃┗┓┃┗┓┃┗┛┃ \n ┗┛━┗┛┗━━┛┗━┛┗━┛┗━━┛](https://t.me/flamingsupport)",
            link_preview=False,
        )
        await salive.delete()
...
pm_caption = "__**🔥🔥FLAMING ɨs օռʟɨռɛ🔥🔥**__\n\n"
...
pm_caption += f"FLAMING       : __**1.69.11**__\n"
pm_caption += f"⚜️Sudo⚜️            : `{sudou}`\n"

pm_caption += "⚠️CHANNEL⚠️   : [ᴊᴏɪɴ](https://t.me/flamingchat)\n"

pm_caption += "🔥CREATOR🔥    : [Nub Here](https://t.me/flaming_AI)\n\n"

pm_caption += "    [✨REPO✨](https://github.com/ITS-FLAMINGBOT/FLAMINGBOT) 🔹 [📜License📜](https://github.com/ITS-FLAMINGBOT/FLAMINGBOT/blob/master/LICENSE)"


@borg.on(flaming_cmd(outgoing=True, pattern="halive$"))
...
@borg.on(flaming_cmd(outgoing=True, pattern="calive$"))

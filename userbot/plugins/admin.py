...
from userbot.utils import flaming_cmd, errors_handler, register
...
@borg.on(flaming_cmd(pattern=r"setgpic"))
...
@borg.on(flaming_cmd(pattern=r"promote(?: |$)(.*)"))
...
@borg.on(flaming_cmd(pattern=r"demote(?: |$)(.*)"))
...
@borg.on(flaming_cmd(pattern=r"ban(?: |$)(.*)"))
...
@borg.on(flaming_cmd(pattern=r"unban(?: |$)(.*)"))
...
@borg.on(flaming_cmd(pattern=r"mute(?: |$)(.*)"))
...
@borg.on(flaming_cmd(pattern=r"unmute(?: |$)(.*)"))
...
@borg.on(flaming_cmd(pattern=r"ungmute(?: |$)(.*)"))
...
@borg.on(flaming_cmd(pattern=r"gmute(?: |$)(.*)"))
...
@borg.on(flaming_cmd(pattern=r"delusers(?: |$)(.*)"))
...
@borg.on(flaming_cmd(pattern=r"adminlist"))
@errors_handler
...
@borg.on(flaming_cmd(pattern=r"pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@borg.on(flaming_cmd(pattern=r"kick(?: |$)(.*)"))
@errors_handler
async def kick(usr):
...
@borg.on(flaming_cmd(pattern=r"users ?(.*)"))
@errors_handler

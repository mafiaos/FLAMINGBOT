...
from uniborg.util import flaming_cmd
...
@borg.on(flaming_cmd(pattern="run ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern="metoo ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern="rapee ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern="insultt ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern="proo ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern="abusee ?(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(flaming_cmd(pattern="geyy ?(.*)"))
async def _(event):
    if event.fwd_from:
        return

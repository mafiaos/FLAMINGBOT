...
class Var(object):
    ...
    # 6 is a placeholder
    FLAMING_PRO = os.environ.get("FLAMING_PRO", None)
    if not FLAMING_PRO:
        FLAMING_PRO = "YES"
    else:
        FLAMING_PRO = FLAMING_PRO
    ...
    ALIVE_PIC = os.environ.get(
        "ALIVE_IMAGE", "https://te.legra.ph/file/2321764bd41e99beab199.jpg"
    )
    CUSTOM_ALIVE_PIC = os.environ.get(
        "CUSTOM_ALIVE_IMG", "https://te.legra.ph/file/2321764bd41e99beab199.jpg"
    )
    ...
    PM_DATA = os.environ.get("PM_DATA", "ENABLE")
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Flaming")
